...
* [10803](https://github.com/apache/incubator-superset/pull/10803): Support for Python 3.6 has been officially discontinued. It may be possible to run Superset with Python 3.6 by installing the `dataclasses` package, but production environments are encouraged to be upgraded to Python 3.7 or 3.8.
