...
class CoreTests(SupersetTestCase):
    ...
    def test_save_slice(self):
        ...
        slc = db.session.query(superset.models.dashboard.Slice).filter_by(id=new_slice_id).one()
    ...
    def test_slices(self):
        ...
        self.login(username="admin")
        Slc = superset.models.dashboard.Slice
        urls = []
    ...
    def test_slice_id_is_always_logged_correctly_on_web_request(self):
        ...
        slc = db.session.query(superset.models.dashboard.Slice).filter_by(slice_name="Girls").one()
