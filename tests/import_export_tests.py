...
class ImportExportTests(SupersetTestCase):
    ...
    def delete_imports(cls):
        with app.app_context():
            ...
            session = db.session
            for slc in session.query(superset.models.dashboard.Slice):
    ...
    def create_slice(
        ...
        return superset.models.dashboard.Slice(
            slice_name=name,
    ...
    def get_slice(self, slc_id):
        return db.session.query(superset.models.dashboard.Slice).filter_by(id=slc_id).first()

    def get_slice_by_name(self, name):
        return db.session.query(superset.models.dashboard.Slice).filter_by(slice_name=name).first()
    ...
    def test_import_1_slice(self):
        ...
        slc_id = superset.models.dashboard.Slice.import_obj(expected_slice, None, import_time=1989)
    ...
    def test_import_2_slices_for_same_table(self):
        ...
        slc_id_1 = superset.models.dashboard.Slice.import_obj(slc_1, None)
        slc_2 = self.create_slice("Import Me 2", ds_id=666, id=10003)
        slc_id_2 = superset.models.dashboard.Slice.import_obj(slc_2, None)
    ...
    def test_import_slices_for_non_existent_table(self):
        with self.assertRaises(AttributeError):
            superset.models.dashboard.Slice.import_obj(
    ...
    def test_import_slices_override(self):
        ...
        slc_1_id = superset.models.dashboard.Slice.import_obj(slc, None, import_time=1990)
        slc.slice_name = "Import Me New"
        imported_slc_1 = self.get_slice(slc_1_id)
        slc_2 = self.create_slice("Import Me New", id=10005)
        slc_2_id = superset.models.dashboard.Slice.import_obj(slc_2, imported_slc_1, import_time=1990)
    ...
    def test_import_dashboard_1_slice(self):
        ...
        imported_dash_id = Dashboard.import_obj(
    ...
    def test_import_override_dashboard_2_slices(self):
        ...
        imported_dash_id_1 = Dashboard.import_obj(
